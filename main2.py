...
#TOPIC = 'paradox/states/zones/kontak/open' # nspanel-demo/sensor/demo_nspanel_temperature/state
TOPIC = 'nspanel-demo/sensor/demo_nspanel_temperature/state' #
...
def on_message(mqtt_client, user_data, message):
    ...
    sql = 'INSERT INTO hometemp (topic, payload, time) VALUES (?, ?, datetime("now", "localtime"))'
...
def main():
    ...
    sql = """
    CREATE TABLE IF NOT EXISTS hometemp (
